        ...
        <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6">
                    ...
                    <!-- Default form login -->
                    <form class="text-center" action="{{ route('post-student-login') }}" method="POST">
                        @csrf
                        <p class="h4 mb-4">{{ __('Student Login') }}</p>
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            @if (Route::has('get-student-password-request-form'))
                            <div>
                                <!-- Forgot password -->
                                <a href="{{ route('get-student-password-request-form') }}" style="color: rgb(148, 16, 148);">{{ __('Forgot Your Password?') }}</a>
                            </div>
                            @endif
                        </div>
                        ...
                        <!-- Register -->
                        <p>Not a member?
                            <a href="" style="color: rgb(148, 16, 148);">Sign Up</a>
                        </p>
